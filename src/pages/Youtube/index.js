                    ...
                    <div className="m-5">
                        ...
                        <div className="mt-5">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href=""><i classNameName="fa-solid fa-fire"></i>&nbsp;Trending</a>
                                </li>
                                <li>
                                    <a href=""
                                    ><i className="fa-brands fa-youtube"></i>&nbsp;Subscriptions</a
                                    >
                                </li>
                                <li>
                                    <a href=""><i className="fa-solid fa-podcast"></i>&nbsp;Live</a>
                                </li>
                            </ul>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href=""><i className="fa-solid fa-barcode"></i>&nbsp;Queue</a>
                                </li>
                                <li>
                                    <a href=""><i className="fa-solid fa-heart"></i>&nbsp;Likes</a>
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li>
                                    <a href=""
                                    ><i className="fa-solid fa-circle-question"></i>&nbsp;Settings</a
                                    >
                                </li>
                                <li>
                                    <a href=""><i className="fa-solid fa-gear"></i>&nbsp;Help</a>
                                </li>
                                <li>
                                    <a href=""
                                    ><i className="fa-solid fa-comments"></i>&nbsp;Feedback</a
                                    >
                                </li>
                            </ul>
                        </div>
