            ...
            <Dialog open={open} onClose={handleOpenDialog}>
                <DialogContent>
                    <Grid container spacing={3}>
                        ...
                        <Grid item md={6}>
                            <TextField label="Link del video" name="video_link" fullWidth onChange={handleChangeInput}/>
                        </Grid>
                        <Grid item md={6}>
                            <TextField label="Link de la portada" name="wallpaper" fullWidth onChange={handleChangeInput}/>
                        </Grid>
                        <Grid item md={6}>
                            <Button variant="contained" onClick={fetchStoreMovie} color="success" fullWidth>Crear</Button>
                        </Grid>
                    </Grid>
                </DialogContent>
            </Dialog>
